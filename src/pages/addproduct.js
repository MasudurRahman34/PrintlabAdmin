                ...
                <div className="grid grid-cols-12 md:gap-x-[3rem] gap-0">
                  <div className="col-span-12 xxl:col-span-6 xl:col-span-12 lg:col-span-12 md:col-span-6">
                    <div className="grid grid-cols-12 gap-4">
                      ...
                      <div className="col-span-12 xl:col-span-6">
                        <label for="product-gender-add" className="form-label">
                          Gender
                        </label>
                        <select
                          className="form-control w-full !rounded-md"
                      ...
                      <div className="col-span-12 xl:col-span-6">
                        <label for="product-size-add" className="form-label">
                          Size
                        </label>
                        <select
                          className="form-control w-full !rounded-md"
                      ...
                      <div className="col-span-12 xl:col-span-6">
                        <label for="product-brand-add" className="form-label">
                          Brand
                        </label>
                        <select
                          className="form-control w-full !rounded-md"
                      ...
                      <div className="col-span-12 xl:col-span-6 color-selection">
                        <label for="product-color-add" className="form-label">
                          Colors
                        </label>
                        <select
                          className="form-control w-full !rounded-md"
                      ...
                      <div className="col-span-12 xl:col-span-6">
                        <label for="product-cost-add" className="form-label">
                          Enter Cost
                        </label>
                        <input
                          type="text"
