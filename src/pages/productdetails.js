                  ...
                  <div className="col-span-12 xxl:col-span-3 xl:col-span-12">
                    <div className="sm:grid grid-cols-12 !gap-x-6 md:me-[1rem] ">
                      <div className="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 md:mb-[3rem] mb-4">
                        <div className="rounded-md swiper swiper-preview-details bg-light product-details-page rtl:dirrtl">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide" id="img-container">
                              <img
                                className="img-fluid"
                        ...
                        <div className="mt-2 swiper swiper-view-details rtl:dirrtl">
                          <div className="swiper-wrapper">
                                ...
                                <td>
                                  <a href="javascript:void(0);">
                                    <div className="flex items-start">
                                      <div className="similar-products-image me-2">
                                        <img
                                          src="../assets/images/ecommerce/png/18.png"
                                          alt=""
                                        />
                                      </div>
                                      <div className="flex-grow">
                                        <p className="mb-1 font-semibold similar-product-name text-truncate">
                                          Orange watch series 3
                                        </p>
                                        <p className="mb-0">
                                          <span className="text-white badge bg-success">
                                            4.1
                                ...
                                <td>
                                  <a href="javascript:void(0);">
                                    <div className="flex items-start">
                                      <div className="similar-products-image me-2">
                                        <img
                                          src="../assets/images/ecommerce/png/19.png"
                                          alt=""
                                        />
                                      </div>
                                      <div className="flex-grow">
                                        <p className="mb-1 font-semibold similar-product-name text-truncate">
                                          Omega watch special edition
                                        </p>
                                        <p className="mb-0">
                                          <span className="text-white badge bg-success">
                                            3.8
                                ...
                                <td>
                                  <a href="javascript:void(0);">
                                    <div className="flex items-start">
                                      <div className="similar-products-image me-2">
                                        <img
                                          src="../assets/images/ecommerce/png/21.png"
                                          alt=""
                                        />
                                      </div>
                                      <div className="flex-grow">
                                        <p className="mb-1 font-semibold similar-product-name text-truncate">
                                          Electro viintage watch(40mm)
                                        </p>
                                        <p className="mb-0">
                                          <span className="text-white badge bg-success">
                                            4.1
                                ...
                                <td>
                                  <a href="javascript:void(0);">
                                    <div className="flex items-start">
                                      <div className="similar-products-image me-2">
                                        <img
                                          src="../assets/images/ecommerce/png/22.png"
                                          alt=""
                                        />
                                      </div>
                                      <div className="flex-grow">
                                        <p className="mb-1 font-semibold similar-product-name text-truncate">
                                          Bolts smart watch(Amoled)
                                        </p>
                                        <p className="mb-0">
                                          <span className="text-white badge bg-success">
                                            4.3
                    ...
                    <div className="md:grid grid-cols-12 gap-x-[3rem]">
                      <div className="col-span-12 mt-4 xl:col-span-8 xxl:mt-0">
                        <p className="text-[1.125rem] font-semibold mb-0">
                          Orange Watch Series 4 (GPS + Cellular, 44mm) - Colored
                          Aluminium Case with Multiple Featured Sports Band -
                          Regular
                        </p>
                        ...
                        <div className="grid grid-cols-12 mb-6">
                          <div className="col-span-12 xxl:col-span-3 xl:col-span-12">
                            <p className="mb-1 lh-1 text-[0.6875rem] text-success font-semibold">
                              Special Offer
                            </p>
                            <p className="mb-1">
                              <span className="font-semibold h3">
                                <sup className="text-[0.875rem]">$</sup>1,299
                                <sup className="text-[0.875rem]">.00</sup>
                              </span>
                              <span className="ms-3 badge bg-danger/10 text-danger">
                                50% Off
                              </span>
                            </p>
                          ...
                          <div className="col-span-12 mt-4 xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 mml:mt-0">
                            <p className="mb-2 text-[.9375rem] font-semibold">
                              Watch Type
                            </p>
                            <div
                            ...
                            >
                              ...
                              />
                              <label
                                className="ti-btn !py-[0.45rem] !px-3 ti-btn-light !border-e-0 !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !font-medium !rounded-e-none hover:!bg-light hover:!text-defaulttextcolor"
                                for="type1"
                              >
                                GPS
                              </label>
                              ...
                              />
                              <label
                                className="ti-btn !py-[0.45rem] !px-3 ti-btn-outline-light !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !rounded-s-none hover:!bg-light hover:!text-defaulttextcolor"
                                for="type2"
                              >
                                GPS+Cellular
                              </label>
                          ...
                          <div className="col-span-12 mt-4 xxl:col-span-5 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 xxl:mt-0">
                            ...
                            >
                              ...
                              />
                              <label
                                className="ti-btn !py-[0.45rem] !px-3 ti-btn-outline-light !border-e-0 !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !font-medium !rounded-none hover:!bg-light hover:!text-defaulttextcolor"
                                for="strap2"
                              >
                                Stainless steel
                              </label>
                              ...
                              />
                              <label
                                className="ti-btn !py-[0.45rem] !px-3 ti-btn-outline-light !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 !text-[0.75rem] !font-medium  !rounded-s-none hover:!bg-light hover:!text-defaulttextcolor"
                                for="strap3"
                              >
                                Synthetic
                              </label>
                        ...
                        <div className="mb-4">
                          <p className="text-[.9375rem] font-semibold mb-1">
                            Description :
                          </p>
                          <p className="text-[#8c9097] dark:text-white/50 mb-0">
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Obcaecati accusamus, quaerat nam quo optio
                            reiciendis harum reprehenderit omnis tempora
                            adipisci in iste aperiam unde, repellendus possimus
                          ...
                          <div className="grid grid-cols-12 gap-x-6">
                            <div className="col-span-12 xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12">
                              ...
                              <p className="flex mb-0">
                                <a
                                  aria-label="anchor"
                                  className="color-1 product-colors selected"
                                  href="javascript:void(0)"
                                >
                                ...
                                <a
                                  aria-label="anchor"
                                  className="color-2 product-colors"
                                  href="javascript:void(0)"
                                >
                                  <i className="ri-checkbox-blank-circle-fill"></i>
                                </a>
                                <a
                                  aria-label="anchor"
                                  className="color-3 product-colors"
                                  href="javascript:void(0)"
                                >
                                  <i className="ri-checkbox-blank-circle-fill"></i>
                                </a>
                                <a
                                  aria-label="anchor"
                                  className="color-4 product-colors"
                                  href="javascript:void(0)"
                                >
                                  <i className="ri-checkbox-blank-circle-fill"></i>
                                </a>
                                <a
                                  aria-label="anchor"
                                  className="color-5 product-colors"
                                  href="javascript:void(0)"
                                >
                                  <i className="ri-checkbox-blank-circle-fill"></i>
                                </a>
                            ...
                            <div className="col-span-12 mt-4 xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 md:mt-0">
                              ...
                              <p className="flex mb-0">
                                <a
                                  className="color-1 product-sizes selected"
                                  href="javascript:void(0)"
                                >
                                  44
                                </a>
                                <a
                                  className="color-2 product-sizes"
                                  href="javascript:void(0)"
                                >
                                  40
                                </a>
                                <a
                                  className="color-3 product-sizes"
                                  href="javascript:void(0)"
                                >
                                  38
                                </a>
                        ...
                        <div className="mb-4">
                          <div className="grid justify-center grid-cols-12 gap-0">
                            <div className="col-span-12 mx-3 mt-4 xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4">
                              <div className="ecommerce-assurance">
                                <p className="inline-flex mb-4">
                                  ...
                                  >
                                    ...
                                    <path
                                      fill="#2d4356"
                                      d="M11 147.119H8a2 2 0 0 0 0 4h3a2 2 0 0 0 0-4zm149 0h-3a2 2 0 0 0 0 4h3a2 2 0 0 0 0-4z"
                                    />
                                    <circle
                                      cx="166"
                                      cy="149.119"
                                    ...
                                    <path
                                      fill="#0bceb2"
                                      d="M118.154 155.119h-8.308a2.006 2.006 0 0 0 0 4h8.308a2.006 2.006 0 0 0 0-4zm-60 0h-8.308a2.006 2.006 0 0 0 0 4h8.308a2.006 2.006 0 0 0 0-4zm45.846 0H64a2 2 0 0 0 0 4h15.94v2H72a2 2 0 0 0 0 4h25a2 2 0 0 0 0-4h-8.94v-2H104a2 2 0 0 0 0-4z"
                                    />
                                    <path
                                      fill="#2d4356"
                                      d="M150.721 147.119h-39.734l.14-12.338 15.307 3.372a1.846 1.846 0 0 0 .193.032 3.002 3.002 0 0 0 2.996-1.498 2.918 2.918 0 0 0-.348-3.356l-6.785-7.632-3.267-.004h-2.034l7.088 7.973-14.682-3.234a2.032 2.032 0 0 0-1.68.373 1.942 1.942 0 0 0-.76 1.513l-.146 12.933-16.497-21.92a15.311 15.311 0 0 1-2.934 2.699l15.872 21.087H60.56l16.196-21.521a18.709 18.709 0 0 1-2.847-2.816L57 145.256l-.147-12.936a1.942 1.942 0 0 0-.76-1.513 2.04 2.04 0 0 0-1.68-.373l-14.681 3.234 14.254-16.035a25.407 25.407 0 0 1-1.286-4.514l-18.004 20.255a2.902 2.902 0 0 0-.31 3.314 3.009 3.009 0 0 0 2.994 1.497 1.846 1.846 0 0 0 .194-.032l15.306-3.373.142 12.339H17.279a2.017 2.017 0 1 0 0 4H150.72a2.017 2.017 0 1 0 0-4zM114 26.119a3 3 0 1 0-3-3 3.003 3.003 0 0 0 3 3zm0-4.5a1.5 1.5 0 1 1-1.5 1.5 1.501 1.501 0 0 1 1.5-1.5zm26 29.378a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zM6 36.119a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zm136-35.5a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zM30 50.997a2 2 0 1 0-2 2 2.002 2.002 0 0 0 2-2zm-3 0a1 1 0 1 1 1 1 1.001 1.001 0 0 1-1-1z"
                                    />
                                    <path
                                      fill="#0bceb2"
                                      d="m12.72 5.368 1.487-1.955-.939-.532-.954 2.19h-.032l-.97-2.175-.955.548 1.471 1.909v.031l-2.301-.297v1.064l2.317-.297v.031l-1.487 1.908.892.564 1.017-2.206h.031l.939 2.19.986-.563L12.72 5.9v-.031l2.362.282V5.087L12.72 5.4v-.032zM44.258 19.07l-.856 1.099.513.325.586-1.271h.018l.541 1.262.568-.325-.865-1.081v-.018l1.36.162v-.613l-1.36.181v-.018l.856-1.127-.541-.306-.55 1.261h-.018l-.558-1.252-.55.315.847 1.1v.018l-1.325-.172v.613l1.334-.171v.018zM164.724 30.786v-1.044l-2.317.307v-.031l1.459-1.918-.921-.521-.936 2.148h-.032l-.95-2.133-.938.537 1.444 1.872v.031l-2.257-.292v1.044l2.272-.291v.03l-1.459 1.872.875.553.999-2.164h.029l.921 2.148.968-.552-1.474-1.842v-.03l2.317.276zM80.004 5.407l1.258-1.655-.795-.45-.807 1.853h-.027l-.82-1.84-.809.464 1.245 1.615v.026l-1.946-.251v.9l1.959-.251v.026l-1.258 1.615.755.477.861-1.867h.026l.794 1.853.835-.476-1.271-1.589v-.026l1.998.238v-.9l-1.998.264v-.026z"
                                    />
                                  </svg>
                                </p>
                            ...
                            <div className="col-span-12 mx-3 mt-4 xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 sm:mt-0">
                              <div className="ecommerce-assurance">
                                <p className="inline-flex mb-4">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  >
                                    ...
                                    <path
                                      fill="url(#a)"
                                      d="M53 26V13.4L32 1.9 11 13.4v25.2l21 11.6 21-11.5V33h-2v4.4L32 47.9l-13-7.2V19l12 6.6V45h2V25.6l18-9.9V26h2zm-3.1-12L32 23.9l-11.9-6.6 17.7-10L49.9 14zM35.6 6.1 18 16.2 14.1 14 32 4.1l3.6 2zM17 39.6l-4-2.2V15.7l4 2.2v21.7z"
                                    />
                                    <linearGradient
                                      id="b"
                                      x1="35.769"
                                    ...
                                    <path
                                      fill="url(#b)"
                                      d="M38 26v2h6c7.2 0 13 5.8 13 13s-5.8 13-13 13H16.4l5.3-5.3-1.4-1.4-7.8 7.7 8.8 7.7 1.3-1.5-6-5.2H44c8.3 0 15-6.7 15-15s-6.7-15-15-15h-6z"
                                    />
                                  </svg>
                                </p>
                                <p className="text-[0.875rem] font-semibold mb-0">
                              ...
                              <div className="ecommerce-assurance">
                                <p className="inline-flex mb-4">
                                  ...
                                  >
                                    <path
                                      fill="#2d4356"
                                      d="M56 93.534V80.415a1.862 1.862 0 0 1 .473-1.23l12.984-14.73a2.121 2.121 0 0 1 1.596-.705H107v18.13h-3.027a2 2 0 0 0-1.56.75A29.22 29.22 0 0 1 89.9 91.785a1.995 1.995 0 0 0-.937.617l-8.99 10.59a2.299 2.299 0 0 1-3.001.354c-1.639-1.12-1.74-1.597-1.425-3.029a10.313 10.313 0 0 1 2.33-4.47l4.987-5.749a1.998 1.998 0 0 0 .445-1.726l-1.85-8.706a2.869 2.869 0 0 0-1.852-1.834l-9.285-1.814a1.996 1.996 0 0 0-1.873.628l-6.613 7.378a2 2 0 0 0-.51 1.335v5.321a17.844 17.844 0 0 1 4-.846v-3.71l5.343-5.962 7.1 1.387 1.42 6.68-4.333 4.997a15.351 15.351 0 0 0-1.503 2.058A13.993 13.993 0 1 0 81 107.75c0-.206-.022-.406-.03-.61a6.051 6.051 0 0 0 2.051-1.558l8.638-10.174a33.3 33.3 0 0 0 13.256-9.528h2.098A3.998 3.998 0 0 0 111 89.75h12a4.005 4.005 0 0 0 4-4v-24a4.005 4.005 0 0 0-4-4h-12a3.987 3.987 0 0 0-3.444 2H71.053a6.124 6.124 0 0 0-4.597 2.06L53.472 76.54A5.86 5.86 0 0 0 52 80.415v17.407a18.127 18.127 0 0 1 4-4.288zm11 24.216a10 10 0 0 1 0-20 9.884 9.884 0 0 1 4.765 1.228c-.046.172-.094.343-.133.516-.846 3.86.981 5.72 3.075 7.15a6.172 6.172 0 0 0 2.284.955c0 .051.009.1.009.151a10.011 10.011 0 0 1-10 10zm44-56h12v24h-12zm-24.942-17.5a3 3 0 1 0-3-3 3.003 3.003 0 0 0 3 3zm0-4.5a1.5 1.5 0 1 1-1.5 1.5 1.501 1.501 0 0 1 1.5-1.5zm39-20.5a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zm-64-6a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zm74 18a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zm-118 31a2 2 0 1 0-2 2 2.002 2.002 0 0 0 2-2zm-3 0a1 1 0 1 1 1 1 1.001 1.001 0 0 1-1-1z"
                                    />
                                    <path
                                      fill="#0bceb2"
                                      d="m45.641 41.261 1.487-1.955-.939-.532-.954 2.19h-.032l-.97-2.175-.955.548 1.471 1.909v.031l-2.301-.297v1.064l2.316-.297v.031l-1.486 1.908.891.564 1.018-2.206h.031l.939 2.19.986-.563-1.502-1.878v-.031l2.362.282V40.98l-2.362.312v-.031zM8.834 29.317l-.856 1.099.514.324.586-1.27h.017l.541 1.261.568-.324-.865-1.082v-.018l1.36.163v-.613l-1.36.18v-.018l.856-1.126-.54-.306-.55 1.261h-.018l-.559-1.253-.55.316.848 1.099v.018l-1.325-.171v.613l1.333-.171v.018zM159.058 61.963V60.92l-2.317.307v-.031l1.458-1.918-.921-.522-.936 2.148h-.031l-.951-2.133-.937.538 1.443 1.872v.031l-2.257-.292v1.043l2.272-.291v.031l-1.458 1.872.875.553.998-2.165h.03l.921 2.149.967-.552-1.473-1.842v-.031l2.317.276zM158.501 19.836l1.258-1.655-.794-.45-.808 1.853h-.027l-.82-1.84-.809.464 1.245 1.615v.026l-1.946-.251v.9l1.959-.252v.027l-1.258 1.615.755.477.861-1.867h.026l.795 1.853.834-.476-1.271-1.589v-.027l1.998.239v-.9l-1.998.264v-.026z"
                                    />
                                    <circle
                                      cx="2"
                                      cy="135.75"
                                    ...
                                    <path
                                      fill="#2d4356"
                                      d="M11 133.75H8a2 2 0 0 0 0 4h3a2 2 0 0 0 0-4zm149 0h-3a2 2 0 0 0 0 4h3a2 2 0 0 0 0-4z"
                                    />
                                    <circle
                                      cx="166"
                                      cy="135.75"
                                    ...
                                    <path
                                      fill="#0bceb2"
                                      d="M118.154 141.75h-8.308a2.006 2.006 0 0 0 0 4h8.308a2.006 2.006 0 0 0 0-4zm-60 0h-8.308a2.006 2.006 0 0 0 0 4h8.308a2.006 2.006 0 0 0 0-4zm45.846 0H64a2 2 0 0 0 0 4h15.94v2H72a2 2 0 0 0 0 4h25a2 2 0 0 0 0-4h-8.94v-2H104a2 2 0 0 0 0-4z"
                                    />
                                    <path
                                      fill="#2d4356"
                                      d="M150.721 133.75h-6.932a14 14 0 1 0-19.578 0H17.28a2.017 2.017 0 1 0 0 4H150.72a2.017 2.017 0 1 0 0-4Zm-26.721-10a10 10 0 1 1 10 10 10.011 10.011 0 0 1-10-10Z"
                                    />
                                    <path
                                      fill="#0bceb2"
                                      d="M26 133.75a2.002 2.002 0 0 1-2-2v-16a2.002 2.002 0 0 1 2-2h16a2.002 2.002 0 0 1 2 2v16a2.002 2.002 0 0 1-2 2h5.65a5.96 5.96 0 0 0 .35-2v-16a6.007 6.007 0 0 0-6-6H26a6.007 6.007 0 0 0-6 6v16a5.96 5.96 0 0 0 .35 2zm66 0a2.002 2.002 0 0 1-2-2v-16a2.002 2.002 0 0 1 2-2h16a2.002 2.002 0 0 1 2 2v16a2.002 2.002 0 0 1-2 2h5.65a5.96 5.96 0 0 0 .35-2v-16a6.007 6.007 0 0 0-6-6H92a6.007 6.007 0 0 0-6 6v16a5.96 5.96 0 0 0 .35 2z"
                                    />
                                  </svg>
                                </p>
                                <p className="text-[0.875rem] font-semibold mb-0">
                            ...
                            <table className="table w-full table-bordered whitespace-nowrap">
                              <tbody>
                                ...
                                <tr className="border border-defaultborder dark:border-defaultborder/10">
                                  ...
                                  <td>
                                    Heart rate sensor,GPS,Wifi calling,SAmoled
                                    display e.t.c
                                  </td>
                                </tr>
                              </tbody>
                        ...
                        <div className="mb-0">
                          <p className="text-[.9375rem] font-semibold mb-3">
                            Reviews &amp; Ratings :
                          </p>
                          <div className="grid-cols-12 gap-6 sm:grid">
                            <div className="col-span-12 xxl:col-span-4 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12">
                              ...
                              <div className="flex items-center mb-4">
                                ...
                                <div className="flex-grow progress progress-xs">
                                  <div
                                    className="progress-bar !bg-success rounded-md w-[55%]"
                                    aria-valuenow="55"
                                    aria-valuemin="0"
                                    aria-valuemax="100"
                                  ></div>
                                </div>
                                <div className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">
                                  (10,893)
                                </div>
                              </div>
                              <div className="flex items-center mb-4">
                                ...
                                <div className="flex-grow progress progress-xs">
                                  <div
                                    className="progress-bar rounded-md !bg-success w-[22%]"
                                    aria-valuenow="22"
                                    aria-valuemin="0"
                                    aria-valuemax="100"
                                  ></div>
                              ...
                              <div className="flex items-center mb-4">
                                ...
                                <div className="flex-grow progress progress-xs">
                                  <div
                                    className="progress-bar rounded-s-md !bg-success w-[8%]"
                                    aria-valuenow="8"
                                    aria-valuemin="0"
                                    aria-valuemax="100"
                                  ></div>
                              ...
                              <div className="flex items-center mb-4">
                                ...
                                <div className="flex-grow progress progress-xs">
                                  <div
                                    className="progress-bar rounded-md !bg-warning w-[9%]"
                                    aria-valuenow="9"
                                    aria-valuemin="0"
                                    aria-valuemax="100"
                                  ></div>
                              ...
                              <div className="flex items-center">
                                ...
                                <div className="flex-grow progress progress-xs">
                                  <div
                                    className="progress-bar rounded-md !bg-danger w-[6%]"
                                    aria-valuenow="6"
                                    aria-valuemin="0"
                                    aria-valuemax="100"
                                  ></div>
                            ...
                            <div className="col-span-12 mt-4 xxl:col-span-8 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 xxl:mt-0">
                              <div className="p-4 border dark:border-defaultborder/10">
                                <div className="items-start block mb-4 sm:flex">
                                ...
                                <div className="mb-4 sm:ps-4 ps-0">
                                  <p className="mb-1 font-semibold ps-2">
                                    Wonderful product&#128512;
                                  </p>
                                  <p className="mb-0 text-[0.75rem] text-[#8c9097] dark:text-white/50 ps-2">
                                    Really this product is very good quality and
                                    best for daily use... It supports Spo2..
                                    Very well..{" "}
                                  </p>
                                </div>
                                <div className="product-images sm:ps-4 ps-0">
                                  <div className="grid-cols-12 gap-6 sm:grid">
                                    ...
                                    <div className="flex items-end col-span-12 mt-2 xl:col-span-6 sm:justify-end sm:mt-0">
                                      <button
                                        type="button"
                                        className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium ti-btn-light me-2 whitespace-nowrap"
                                      >
                                        Report abuse
                                      </button>
                                      <button
                                        aria-label="button"
                                        type="button"
                                        className="ti-btn ti-btn-sm ti-btn-primary me-2"
                                      >
                      ...
                      <div className="col-span-12 mt-6 xl:col-span-4 xxl:mt-0">
                        <div className="mb-[3rem]">
                          <div className="mb-6 offer-promotion dark:border-defaultborder/10">
                            <div className="flex flex-wrap items-center justify-between xxl:flex lg:block sm:flex">
                              <div className="mb-2 text-warning xxxl:mb-0">
                                Use Code{" "}
                                <span className="font-semibold promotion-code">
                                  FIRBUY
                                </span>
                                <a
                                  className="text-[.625rem] text-warning ms-1"
                                  href="javascript:void(0);"
                                >
                                  T&amp;C.
                                </a>
                              ...
                              <div className="sm:mt-0">
                                <span className="bg-warning/10 text-defaulttextcolor text-[0.75rem] offer-details mb-0 hover:text-warning">
                                  Get it for{" "}
                          ...
                          <div className="mb-6">
                            <p className="text-danger mb-0 text-[1rem]">
                          ...
                          <div className="mb-6">
                            <ul className="list-group">
                              <li className="list-group-item">
                                <div className="leading-none">
                                  <span className="text-success font-semibold text-[0.875rem] flex items-center">
                              ...
                              <li className="list-group-item">
                                <div className="text-[0.75rem] text-default">
                                  ...
                                  <span className="flex-grow">
                                    No cost emi on selected bank card on min
                                    purchase of $1,499
                                    <a
                                      href="javascript:void(0);"
                                      className="text-primary ms-1"
                              ...
                              <li
                                className="list-group-item !p-0 hs-collapse hidden w-full overflow-hidden transition-[height] duration-300"
                                ...
                                <ul className="list-group" id="offers-more">
                                  ...
                                  <li className="border-0 list-group-item">
                                    <div className="text-[0.75rem] text-default">
                                      ...
                                      <span className="flex-grow">
                                        Offer upto 30% on grosery on purchase of
                                        this item
                                        <a
                                          href="javascript:void(0);"
                                          className="text-primary ms-1"
                              ...
                              <li className="border-t-0 list-group-item">
                                <a
                                  className="text-success text-[0.75rem] hs-collapse-toggle inline-flex items-center gap-x-2"
                                  href="javascript:void(0);"
                          ...
                          <div className="mb-4">
                            ...
                            <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50">
                              Min 7 days return and exchange policy. Return
                              Policies may vary based on products and
                              promotions. For full details on our Returns
                              Policies, please{" "}
                              <a
                                href="javascript:void(0);"
                          ...
                          <div
                            className="alert alert-light mb-6 text-[0.75rem] text-[#8c9097] dark:text-white/50"
                            role="alert"
                          >
                        ...
                        <div className="text-center">
                          <a aria-label="anchor" href="javascript:void(0);">
                            <img
                              src="../assets/images/ecommerce/png/25.png"
                              alt=""
