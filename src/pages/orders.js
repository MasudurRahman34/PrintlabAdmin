...
const Orders = () => {
    return (
      ...
      <div className="block justify-between page-header md:flex">
          <div>
              <h3 className="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Orders</h3>
          </div>
      ...
      <ul className="ti-pagination !px-3 !py-[0.375rem] !text-[1rem] !mb-4 flex justify-end">
          ...
          <li className="page-item"><a className="page-link !px-3 !py-[0.375rem]" href="javascript:void(0);">1</a></li>
          <li className="page-item"><a className="page-link !px-3 !py-[0.375rem]" href="javascript:void(0);">2</a></li>
          <li className="page-item"><a className="page-link !px-3 !py-[0.375rem]" href="javascript:void(0);">3</a></li>
          <li className="page-item">
              <a className="page-link !px-3 !py-[0.375rem]" href="javascript:void(0);">Next</a>
          </li>
      </ul>
