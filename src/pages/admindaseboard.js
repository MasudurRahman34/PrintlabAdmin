                      ...
                      <div className="box-body">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <span className="block font-semibold mt-[0.125rem]"><a className="text-white text-[0.813rem]"
                  ...
                  <div className="xxl:col-span-12 xl:col-span-12 col-span-12">
                    <div className="box">
                      <div className="box-header justify-between">
                        ...
                        <div className="hs-dropdown ti-dropdown">
                          <a href="javascript:void(0);" className="px-2 font-normal text-[0.75rem] text-[#8c9097] dark:text-white/50"
                            aria-expanded="false">
                          ...
                          <div className="flex items-top justify-between">
                            ...
                            <div className="flex-grow ms-4">
                              ...
                              <div className="flex items-center justify-between !mt-1">
                                <div>
                                  <a className="text-primary text-[0.813rem]" href="javascript:void(0);">View All<i
                        ...
                        <div className="box-body">
                          <div className="flex items-top justify-between">
                            ...
                            <div className="flex-grow ms-4">
                              ...
                              <div className="flex items-center justify-between mt-1">
                                <div>
                                  <a className="text-secondary text-[0.813rem]" href="javascript:void(0);">View All<i
                                      className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></a>
                                </div>
                                <div className="text-end">
                        ...
                        <div className="box-body">
                          <div className="flex items-top justify-between">
                            ...
                            <div className="flex-grow ms-4">
                              ...
                              <div className="flex items-center justify-between mt-1">
                                <div>
                                  <a className="text-success text-[0.813rem]" href="javascript:void(0);">View All<i
                                      className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></a>
                                </div>
                                <div className="text-end">
                        ...
                        <div className="box-body">
                          <div className="flex items-top justify-between">
                            ...
                            <div className="flex-grow ms-4">
                              ...
                              <div className="flex items-center justify-between mt-1">
                                <div>
                                  <a className="text-warning text-[0.813rem]" href="javascript:void(0);">View All<i
                                      className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></a>
                                </div>
                                <div className="text-end">
                  ...
                  <div className="box">
                    ...
                    <div className="box-body overflow-hidden">
                      <div className="leads-source-chart flex items-center justify-center">
                        <canvas id="leads-source" className="chartjs-chart w-full"></canvas>
                            ...
                            <div className="flex items-start">
                              ...
                              <div className="crm-timeline-content text-defaultsize">
                                <span className="font-semibold ">Update of calendar events
                                  &amp;</span><span><a href="javascript:void(0);" className="text-primary font-semibold">
                            ...
                            <div className="flex items-start">
                              ...
                              <div className="crm-timeline-content">
                                <span>Completed documentation of <a href="javascript:void(0);"
                                    className="text-purple underline font-semibold">AI Summit.</a></span>
                              </div>
                              <div className="flex-grow text-end">
                                <span className="block text-[#8c9097] dark:text-white/50 text-[0.6875rem] opacity-[0.7]">4 hrs</span>
                              </div>
