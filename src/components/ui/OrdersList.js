...
export default function OrdersList() {
  return (
    <div className="box">
      <div className="justify-between box-header sm:flex">
      ...
      <div className="card-body !p-0">
        <div className="table-responsive">
          <table className="table min-w-full whitespace-nowrap">
            <thead>
              <tr>
                <th scope="col" className="text-start min-w-[22rem]">
                  Item
                </th>
                ...
                <td>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="mb-1">
                        <span className="me-1">Dial Size:</span>
      ...
      <div className="border-t-0 box-footer">
        <div className="btn-list ltr:float-right rtl:float-left">
          <button
            aria-label="button"
            type="button"
            className="ti-btn bg-primary text-white !py-1 !px-2 !font-medium mr-4 "
            onclick="javascript:window.print();"
          >
            <i className="inline-block align-middle ri-printer-line me-1"></i>
            Print
          </button>
          <button
            aria-label="button"
            type="button"
            className="ti-btn bg-secondary text-white !py-1 !px-2 !font-medium"
          >
            <i className="inline-block align-middle ri-share-forward-line me-1"></i>
            Share Details
          </button>
        </div>
      </div>
